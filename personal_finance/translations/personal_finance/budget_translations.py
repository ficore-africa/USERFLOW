...
BUDGET_TRANSLATIONS = {
    'en': {
        ...
        'budget_subtitle': 'Manage Your Budget',
        'budget_surplus': 'Budget Surplus',
        'budget_deficit': 'Budget Deficit',
        'budget_income_invalid': 'Invalid Income Amount',
        'budget_housing_invalid': 'Invalid Housing Amount',
        'budget_housing_help': 'Enter your monthly housing or rent expenses.',
        ...
        'budget_food_invalid': 'Invalid Food Amount',
        'budget_food_help': 'Enter your monthly food expenses.',
        'budget_transport_invalid': 'Invalid Transport Amount',
        'budget_transport_help': 'Enter your monthly transportation expenses.',
        'budget_dependents_invalid': 'Invalid Number of Dependents',
        'budget_dependents_help': 'Enter the number of dependents you support.',
        'budget_miscellaneous_invalid': 'Invalid Miscellaneous Amount',
        'budget_miscellaneous_help': 'Enter any miscellaneous monthly expenses.',
        'budget_others_invalid': 'Invalid Other Expenses Amount',
        'budget_others_help': 'Enter any other monthly expenses not listed.',
        'budget_savings_goal_invalid': 'Invalid Savings Goal Amount',
        'budget_user_email': 'User Email',
        'budget_insights': 'Budget Insights',
        'budget_date': 'Budget Date',
        'budget_confirm_delete': 'Confirm Budget Deletion',
        'budget_chart_error': 'Error Displaying Budget Chart',
        'budget_amount_max': 'Maximum Budget Amount',
        'budget_dependents_max': 'Maximum Dependents',
        ...
        'budget_log_error': 'Failed to log budget data',
        'budget_dashboard_load_error': 'Unable to load budget dashboard',
        'budget_title': 'Budget Overview',
        'budget_manage_finances': 'Manage Your Finances',
        'budget_tip_monthly_savings': 'Tip: Save a portion of your income monthly',
    ...
    'ha': {
        ...
        'budget_insight_budget_surplus': 'Ragowar Kasafin Kuɗi',
        'budget_amount_max': 'Mafi yawan Adadin Kasafin Kuɗi',
        'budget_dependents_max': 'Mafi yawan Masu Dogara',
        'budget_history': 'Tarihin Kasafin Kuɗi',
        'budget_date': 'Kwanan Kasafin Kuɗi',
        'budget_confirm_delete': 'Tabbatar da Goge Kasafin Kuɗi',
        'budget_chart_error': 'Kuskure wajen Nuna Jadawalin Kasafin Kuɗi',
        ...
        'budget_subtitle': 'Gudanar da Kasafin Kuɗinku',
        'budget_income_invalid': 'Adadin Kuɗin Shiga Ba Daidai Ba',
        'budget_housing_invalid': 'Adadin Kuɗin Gida Ba Daidai Ba',
        'budget_surplus': 'Rage Kasafin Kuɗi',
        'budget_deficit': 'Gibin Kasafin Kuɗi',
        'budget_deleted_success': 'An Goge Kasafin Kuɗi cikin Nasara',
        'budget_housing_help': 'Shigar da kuɗin gida ko haya na kowane wata.',
        ...
        'budget_miscellaneous_invalid': 'Adadin Kuɗin Daban-daban Ba Daidai Ba',
        'budget_miscellaneous_help': 'Shigar da duk wani kuɗin daban-daban na kowane wata.',
        'budget_others_invalid': 'Adadin Sauran Kuɗin Kashewa Ba Daidai Ba',
        'budget_others_help': 'Shigar da duk wani sauran kuɗin kashewa na kowane wata da ba a jera ba.',
        'budget_savings_goal_invalid': 'Adadin Maƙasudin Tanadi Ba Daidai Ba',
        'budget_performance_description': 'Kwatantu ayyukan gaske da kasafin kuɗi da tsinkaya.',
        'budget_user_email': 'Imel na Mai Amfani',
        'budget_insights': 'Fahimtar Kasafin Kuɗi',
